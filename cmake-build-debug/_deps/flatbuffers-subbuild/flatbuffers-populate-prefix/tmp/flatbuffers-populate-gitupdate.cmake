...
execute_process(
  COMMAND "/usr/bin/git" show-ref "v1.12.0"
  WORKING_DIRECTORY "/home/yzy/CLionProjects/Yolo_EdgeTPU/cmake-build-debug/flatbuffers"
...
if("${show_ref_output}" MATCHES "refs/remotes/v1.12.0")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "v1.12.0")
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'https://github.com/google/flatbuffers'")
  endif()
    ...
    if("REBASE" STREQUAL "CHECKOUT")
      ...
      if(error_code)
        ...
        if(NOT "REBASE" STREQUAL "REBASE_CHECKOUT")
          ...
          message(FATAL_ERROR "\nFailed to rebase in: '/home/yzy/CLionProjects/Yolo_EdgeTPU/cmake-build-debug/flatbuffers'."
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/home/yzy/CLionProjects/Yolo_EdgeTPU/cmake-build-debug/flatbuffers'."
                              "\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
