...
execute_process(
  COMMAND "/usr/bin/git" show-ref "d10b27fe37736d2944630ecd7557cefa95cf87c9"
  WORKING_DIRECTORY "/home/yzy/CLionProjects/Yolo_EdgeTPU/cmake-build-debug/eigen"
...
if("${show_ref_output}" MATCHES "refs/remotes/d10b27fe37736d2944630ecd7557cefa95cf87c9")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "d10b27fe37736d2944630ecd7557cefa95cf87c9")
  set(git_remote "${CMAKE_MATCH_1}")
  set(git_tag "${CMAKE_MATCH_2}")
else()
  set(git_remote "origin")
  set(git_tag "d10b27fe37736d2944630ecd7557cefa95cf87c9")
endif()
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'https://gitlab.com/libeigen/eigen'")
  endif()
    ...
    if("REBASE" STREQUAL "CHECKOUT")
      ...
      if(error_code)
        ...
        if(NOT "REBASE" STREQUAL "REBASE_CHECKOUT")
          ...
          message(FATAL_ERROR "\nFailed to rebase in: '/home/yzy/CLionProjects/Yolo_EdgeTPU/cmake-build-debug/eigen'."
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/home/yzy/CLionProjects/Yolo_EdgeTPU/cmake-build-debug/eigen'."
                              "\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
